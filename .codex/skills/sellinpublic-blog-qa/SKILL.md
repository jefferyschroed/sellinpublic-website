...
11. Reject FAQ sections with blank, whitespace-only, duplicate, placeholder, or visually empty question rows. Compare `article.blocks.json`, JSON-LD, and rendered HTML when reviewing FAQ output.
